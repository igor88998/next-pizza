        ...
        <div className={cn('flex items-center justify-center flex-1 relative w-full', className)}>
            <img 
                ...
                className={cn('relative transition-all z-10 duration-300', {
                    ...
                    'w-[385px] h-[385px]' : size === 30,
                    'w-[470px] h-[470px]' : size === 40,
                })}
            />
            ...
            <div className='absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 border-dashed border-2 rounded-full border-gray-200 w-[290px] h-[290px]' />
        </div>
    )
}
